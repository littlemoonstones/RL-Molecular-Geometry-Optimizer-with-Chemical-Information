...
if __name__ == "__main__":
    ...
    parser.add_argument("--pre_trained", default=None, help="whether load previous model")
    ...
    if args.pre_trained:
        previous_model_path = Path(args.pre_trained)
        if not previous_model_path.exists():
            raise Exception("Previous model folder not exists:", previous_model_path)
